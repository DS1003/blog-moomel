                ...
                <div className="grid lg:grid-cols-2 gap-12 items-start">
                    ...
                    <div className="bg-white rounded-3xl p-8 md:p-10 shadow-lg animate-fade-in">
                        <form className="space-y-6">
                            <div className="grid md:grid-cols-2 gap-6">
                                <div>
                                    <label htmlFor="firstName" className="block text-sm font-medium text-neutral-700 mb-2">{t.contact.form.first_name}</label>
                                    <input type="text" id="firstName" className="w-full px-4 py-3 rounded-xl border border-neutral-200 focus:border-primary-500 focus:ring-2 focus:ring-primary-200 outline-none transition-all bg-neutral-50" placeholder={t.contact.form.first_name_placeholder} />
                                </div>
                                <div>
                                    <label htmlFor="lastName" className="block text-sm font-medium text-neutral-700 mb-2">{t.contact.form.last_name}</label>
                                    <input type="text" id="lastName" className="w-full px-4 py-3 rounded-xl border border-neutral-200 focus:border-primary-500 focus:ring-2 focus:ring-primary-200 outline-none transition-all bg-neutral-50" placeholder={t.contact.form.last_name_placeholder} />
                                </div>
                            </div>
                            ...
                            <div>
                                <label htmlFor="subject" className="block text-sm font-medium text-neutral-700 mb-2">{t.contact.form.subject}</label>
                            ...
                            <div>
                                ...
                                <textarea id="message" rows={5} className="w-full px-4 py-3 rounded-xl border border-neutral-200 focus:border-primary-500 focus:ring-2 focus:ring-primary-200 outline-none transition-all bg-neutral-50 resize-none" placeholder={t.contact.form.message_placeholder}></textarea>
                            </div>
                    ...
                    <div className="space-y-8 animate-fade-in" style={{ animationDelay: '0.2s' }}>
                        <div className="bg-primary-900 text-white rounded-3xl p-8 md:p-10 shadow-xl relative overflow-hidden">
                            ...
                            <h3 className="text-2xl font-serif mb-6 relative z-10">{t.contact.info.title}</h3>
                            ...
                            <div className="space-y-6 relative z-10">
                                <div className="flex items-start space-x-4">
                                    ...
                                    <div>
                                        <p className="font-medium text-lg">{t.contact.info.hq}</p>
                                ...
                                <div className="flex items-start space-x-4">
                                    ...
                                    <div>
                                        <p className="font-medium text-lg">{t.contact.info.phone}</p>
                        ...
                        <div className="bg-neutral-100 rounded-3xl p-8 border border-neutral-200">
                            <h3 className="text-xl font-serif text-neutral-900 mb-4">{t.contact.faq.title}</h3>
